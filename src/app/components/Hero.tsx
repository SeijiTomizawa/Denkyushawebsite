...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 flex items-center justify-center pt-32 md:pt-24 pb-48 md:pb-80">
      ...
      <div 
        className="relative z-20 mb-auto pt-24 md:pt-32 text-center"
        style={{ animation: 'fadeInSlow 2s ease-out 0.5s both' }}
      >
        <div 
          className="text-xs md:text-sm tracking-[0.4em] uppercase text-[#e8c292] opacity-90 mb-6 md:mb-8"
          style={{ 
            fontFamily: "'Cormorant Garamond', serif", 
            fontWeight: 300,
            textShadow: '0 0 20px rgba(232, 194, 146, 0.5), 0 0 40px rgba(232, 194, 146, 0.3)'
          }}
        >
          Private Web Agency
        </div>
        <h1 
          className="text-5xl md:text-8xl tracking-wider leading-relaxed text-[#e8c292]"
          style={{ 
            fontFamily: "'Noto Serif JP', serif",
            fontWeight: 300,
            textShadow: '0 0 30px rgba(232, 194, 146, 0.7), 0 0 60px rgba(232, 194, 146, 0.4), 0 0 90px rgba(232, 194, 146, 0.2)'
          }}
        >
          電究社
        </h1>
      ...
      <div 
        className="relative z-20 mt-auto pb-24 md:pb-32 text-center max-w-2xl"
        style={{ animation: 'fadeInSlow 2s ease-out 1.2s both' }}
      >
        <p 
          className="text-sm md:text-lg text-[#e8c292] mb-12 md:mb-16 leading-loose tracking-wider opacity-90"
          style={{ 
            fontFamily: "'Noto Serif JP', serif", 
            fontWeight: 300,
            textShadow: '0 0 15px rgba(232, 194, 146, 0.4)'
          }}
        >
          暗闇の中の聖域<br />
          一筋の光が、新しい世界を照らす
      ...
      <div 
        className="absolute bottom-12 md:bottom-16 left-1/2 -translate-x-1/2 divider-line"
